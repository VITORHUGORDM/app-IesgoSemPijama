		...
		<section id="historia" className="py-20 bg-zinc-950 text-white">
			<div className="container mx-auto px-4 max-w-4xl">
				<h2 className="text-4xl font-bold mb-10 text-center">
					NOSSA{" "}
					<span className="bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 bg-[length:200%_200%] bg-clip-text text-transparent animate-gradient">
						HISTORIA
					</span>
				</h2>
				...
				<div className="bg-zinc-900/90 border border-white/10 rounded-2xl p-8 md:p-10 backdrop-blur hover:border-purple-500 transition-all duration-300 hover:shadow-[0_0_28px_rgba(168,85,247,0.55)]">
					...
					<p className="text-gray-300 leading-relaxed">
						...
						"Aqui ninguem vai de pijama." A frase pegou, virou lema e, no ano
						seguinte, nasceu o Iesgo Sem Pijama: uma maratona de conhecimento,
						criatividade e conexoes que atravessa a madrugada com tecnologia,
						musica e desafios ao vivo.
					</p>
				</div>
			</div>
		</section>
