  ...
  return (
    <section className="relative z-20 -mt-20 px-4 container mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 text-white">
      <div className="bg-zinc-900/90 backdrop-blur border border-white/10 p-8 rounded-2xl flex flex-col items-center text-center hover:border-purple-500 transition-all duration-300 hover:scale-105 transform hover:shadow-[0_0_28px_rgba(168,85,247,0.55)]">
        ...
        <h3 className="text-xl font-bold">26 DE ABRIL</h3>
      ...
      <div className="bg-zinc-900/90 backdrop-blur border border-white/10 p-8 rounded-2xl flex flex-col items-center text-center hover:border-blue-500 transition-all duration-300 hover:scale-105 transform hover:shadow-[0_0_28px_rgba(59,130,246,0.55)]">
