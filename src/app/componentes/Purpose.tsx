    ...
    <section id="sobre" className="py-20 bg-zinc-950 text-white">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold mb-12 text-center">
          NOSSO <span className="text-purple-500">PROPÓSITO</span>
        </h2>
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-zinc-900 p-8 rounded-xl border-l-4 border-purple-500 hover:-translate-y-2 transition">
          ...
          <div className="bg-zinc-900 p-8 rounded-xl border-l-4 border-pink-500 hover:-translate-y-2 transition">
          ...
          <div className="bg-zinc-900 p-8 rounded-xl border-l-4 border-blue-500 hover:-translate-y-2 transition">
